...
const DesignStats = () => {
  return (
    <section className="w-full bg-[#A7B582] py-20 lg:py-32 px-6 md:px-10 lg:px-20 overflow-hidden">
      <div className="max-w-[1400px] w-full mx-auto flex flex-col">
        
        {/* Header Section */}
        <div className="flex flex-col items-center justify-center text-center mb-12 lg:mb-20">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-[70px] font-semibold uppercase tracking-tight">
        ...
        {/* Grid Layout */}
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 min-h-[600px] xl:min-h-[700px]">
