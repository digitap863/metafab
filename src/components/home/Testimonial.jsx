...
const Testimonial = () => {
  ...
  return (
    ...
    <div className="relative w-full py-20 lg:py-32 overflow-hidden flex items-center justify-center min-h-[600px] lg:min-h-[800px]">
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20 flex flex-col items-center">
        {/* Header */}
        <h4 className="text-white/90 text-xs md:text-sm font-medium tracking-widest mb-3">Testimonials</h4>
        <h2 className="text-white text-4xl md:text-5xl lg:text-6xl font-medium tracking-tight uppercase text-center mb-8">
          Our Happy Customers
        </h2>
        ...
        <div className="w-full relative px-10 md:px-20 lg:px-28 mt-4">
            ...
            {testimonials.map((item) => (
              <SwiperSlide key={item.id}>
                <div className="flex flex-col items-center justify-center text-center">
                  ...
                  {/* Text */}
                  <p className="text-white/90 text-sm md:text-sm lg:text-[15px] leading-relaxed max-w-4xl mx-auto mb-10 font-light">
                    {item.text}
                  </p>
          ...
          <button 
            className="testi-prev absolute left-0 md:left-4 top-1/2 -translate-y-1/2 z-20 w-10 h-10 md:w-12 md:h-12 border-2 border-white rounded-lg flex items-center justify-center bg-black/40 hover:bg-black/60 transition-colors cursor-pointer text-white"
          >
          ...
          <button 
            className="testi-next absolute right-0 md:right-4 top-1/2 -translate-y-1/2 z-20 w-10 h-10 md:w-12 md:h-12 border-2 border-white rounded-lg flex items-center justify-center bg-black/40 hover:bg-black/60 transition-colors cursor-pointer text-white"
          >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
