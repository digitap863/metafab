      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 md:h-[650px] lg:h-[750px]">
          ...
          <div className="flex flex-col gap-4 md:gap-6 h-full">
            ...
            <div className="rounded-xl overflow-hidden relative  aspect-[3/4] md:aspect-auto w-full md:h-[60%] group">
          ...
          <div className="flex flex-col gap-4 md:gap-6 h-full">
            ...
            {/* Metafab Logo */}
            <div className="bg-white rounded-xl border border-gray-100  flex items-center justify-center aspect-[2/1] md:aspect-auto w-full md:h-[25%] overflow-hidden ">
              <img src="/choosesec/metafab.svg" alt="Metafab Logo" className="w-2/3 md:w-4/5 object-fit w-full h-auto" />
            </div>

            {/* Chairs */}
            <div className="bg-white rounded-xl px-4 pt-4 pb-0 flex items-end justify-center aspect-[2/1] md:aspect-auto w-full md:h-[30%] relative overflow-hidden group">
