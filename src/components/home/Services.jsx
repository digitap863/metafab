...
const Services = () => {
  ...
  return (
    <section className="bg-white pt-16 pb-4 lg:pt-32 lg:pb-20 w-full">
      <div className="max-w-[1400px] mx-auto px-4 md:px-10">

        {/* Top Header Section */}
        <div className="grid grid-cols-1 lg:grid-cols-12 border-t border-[#E5E5E5] pt-12 gap-5 lg:gap-0">
