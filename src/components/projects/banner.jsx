  ...
  return (
    ...
    <div className="w-full bg-[#A7B582] pt-24 pb-16 px-6 md:px-10 lg:px-20 lg:pt-40 lg:pb-24 overflow-hidden">
      <div className="max-w-[1400px] w-full flex gap-10">
        ...
        {/* Main Heading */}
        <h1 
          className="text-[14vw] sm:text-[12vw] md:text-[100px] lg:text-[130px]  font-bold leading-none tracking-tighter mb-4 md:mb-8"
          data-aos="fade-up"
    ...
    <div className="w-full flex flex-col">
      {projects.map((project, index) => {
        ...
        return (
          <div
            key={project.id}
            className={`w-full py-10 md:py-16 px-6 md:px-10 lg:px-20 flex justify-center ${
              isFirstTwo ? "bg-[#A7B582]" : "bg-white"
            }`}
          >
            <div className="max-w-[1400px] w-full flex flex-col md:flex-row gap-6 md:gap-10 items-stretch">
              ...
              {/* Details Box */}
              <div
                className={`w-full md:w-[30%] flex flex-col justify-center p-8 lg:p-14 rounded-2xl ${
                  isFirstTwo ? "bg-white text-[#071F07]" : "bg-[#A7B582] text-white"
                }`}
                data-aos="fade-left"
                data-aos-duration="1000"
                data-aos-delay="200"
